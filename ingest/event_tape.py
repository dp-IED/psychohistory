...
def _build_parser() -> argparse.ArgumentParser:
    ...
    merge.add_argument("--raw-gdelt", default="data/gdelt/raw/arab_spring")
    merge.add_argument("--acled-raw", default="data/acled/raw/arab_spring")
    merge.add_argument("--out", default="data/arab_spring/events.jsonl")
    merge.add_argument("--cleanup-fragments", action="store_true")
    return parser
