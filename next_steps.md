...
4. **Use of run results** — grill in [`docs/plans/2026-08-19-scale-forecast-roadmap.md`](docs/plans/2026-08-19-scale-forecast-roadmap.md). Locked: forecasts scored, openings not, playbooks not the product (ADR 0014).
