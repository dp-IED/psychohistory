...
4. **Use of run results / evolution** — ADR 0014–0018. Party-sourced discover (public Amfis-like recordings). Reflector + `exp/` experiments. Tenant openings in chat. Forecasts in repo.
