...
4. **Use of run results (not a parallel product)** — after series resolve and analog cards exist, harvest Structure blocks into transferable mechanisms; compose cards only after transfer reopen. Long-term base/superstructure/mental modeling is that overlay, not a restored GNN. Grill and locks: [`docs/plans/2026-08-19-scale-forecast-roadmap.md`](docs/plans/2026-08-19-scale-forecast-roadmap.md).
