...
4. **Use of run results** — grill in [`docs/plans/2026-08-19-scale-forecast-roadmap.md`](docs/plans/2026-08-19-scale-forecast-roadmap.md). ADR 0014–0015: one analog-card pile; tenant openings in the harness, not `ledger.md`.
