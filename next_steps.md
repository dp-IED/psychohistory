...
4. **Use of run results** — grill in [`docs/plans/2026-08-19-scale-forecast-roadmap.md`](docs/plans/2026-08-19-scale-forecast-roadmap.md). Locked: forecasts scored; tenant openings private; internationalist **opening types** + analog cards shared after reflection (ADR 0014–0015).
