...
3. **Live claims / reflect** — `P-usca-338` is past (Resolution 2026-08-22; tariff card already transferred; 26 Aug reflect did not change that overlay). 25 Aug runoffs graded 26 Aug: Graham, Thomas, and Mazzei all matched on the 19 Aug rows (prize = early hit). Missing method was a card; live overlay now has `references/cases/majority-primary-runoff.md`. No Resolution slide. `P-il-knesset-26` remains the hard months-out starter. Near clocks: Iceland 29 Aug, GW 30 Aug, MA 1 Sep.
