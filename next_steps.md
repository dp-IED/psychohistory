...
4. **Use of run results** — plain-language questions to lock before treating overlay as a model of “how society works”: [`docs/plans/2026-08-19-scale-forecast-roadmap.md`](docs/plans/2026-08-19-scale-forecast-roadmap.md).
