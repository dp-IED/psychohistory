...
4. **Put durable facts in the overlay, not a sidecar vault.** Prefer `references/` for long-form procedures, strategies, and durable facts (`CONTEXT.md:19-21`; `docs/adr/0007-reflection-grows-the-plugin.md:5`). Do not write `graph-vault/` (`skills/reflect/SKILL.md:15`). Do not restore `references/vault.md` (`tests/test_plugin_overlay.py:45`). GNN analysis stays parked (`docs/adr/0007-reflection-grows-the-plugin.md:5`); do not recreate a vault corpus to enable it.
