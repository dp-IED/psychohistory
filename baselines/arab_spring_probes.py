...
ARAB_SPRING_BASE_PROBE_DEFS: tuple[ProbeRecord, ...] = (
    ...
    _probe_record(
        ...
        horizon_days=7,
        context_snippet="UGTT strike calendar after Ben Ali exit",
        as_of=_V0_ORIGIN,
    ...
    _probe_record(
        probe_id="ar_base_01",
        nl_text="Base seed: Egyptian military council maintaining order continuity.",
        geography=["Egypt"],
        actor_type=["government"],
        entity_hints=["Supreme Council of the Armed Forces"],
        state_flags=["sustained"],
        horizon_days=14,
        context_snippet="SCAF transitional decree cycle",
        as_of=_V0_ORIGIN,
        assumption_emphasis=AssumptionEmphasis.PERSISTENCE,
        template_id="arab_spring_base_seed_v0",
        seed=_GLOBAL_SEED,
    ...
    _probe_record(
        probe_id="ar_base_02",
        nl_text="Base seed: Libyan NTC authority consolidation in western towns.",
        geography=["Libya"],
        actor_type=["government"],
        entity_hints=["National Transitional Council"],
        state_flags=["sustained"],
        horizon_days=21,
        context_snippet="NTC municipal integration pressure",
        as_of=_V0_ORIGIN,
        assumption_emphasis=AssumptionEmphasis.PERSISTENCE,
        template_id="arab_spring_base_seed_v0",
        seed=_GLOBAL_SEED,
    ...
    _probe_record(
        probe_id="ar_base_03",
        nl_text="Base seed: Tunisian Ennahda party institutional persistence after elections.",
        geography=["Tunisia"],
        actor_type=["opposition_coalition"],
        entity_hints=["Ennahda"],
        state_flags=["sustained"],
        horizon_days=7,
    ...
    _probe_record(
        ...
        geography=["Libya"],
        actor_type=["protest_group"],
        entity_hints=["February 17 Martyrs Brigade"],
        state_flags=["escalating"],
        horizon_days=14,
    ...
    _probe_record(
        probe_id="ar_base_11",
        nl_text="Base seed: Tunisian blogger network as precursor signal.",
        geography=["Tunisia"],
        actor_type=["opposition_coalition"],
        entity_hints=["UGTT"],
        state_flags=["sustained"],
        horizon_days=7,
        context_snippet="blog post velocity spike",
        as_of=date(2010, 12, 15),
        assumption_emphasis=AssumptionEmphasis.PRECURSOR,
        template_id="arab_spring_base_seed_v0",
        seed=_GLOBAL_SEED,
    ...
    _probe_record(
        probe_id="ar_base_12",
        nl_text="Base seed: Ben Ali security apparatus dampening street action.",
        geography=["Tunisia"],
        actor_type=["government"],
        entity_hints=["Ben Ali"],
        state_flags=["sustained"],
        horizon_days=7,
        context_snippet="interior ministry deployment orders",
        as_of=date(2010, 12, 15),
    ...
    _probe_record(
        probe_id="ar_base_13",
        nl_text="Base seed: Egyptian riot police capacity constraining Tahrir intensity.",
        geography=["Egypt"],
        actor_type=["government"],
        entity_hints=["Supreme Council of the Armed Forces"],
        state_flags=["sustained"],
        horizon_days=14,
        context_snippet="Central Security Forces deployment schedule",
        as_of=_V0_ORIGIN,
        assumption_emphasis=AssumptionEmphasis.SUPPRESSION,
        template_id="arab_spring_base_seed_v0",
        seed=_GLOBAL_SEED,
    ...
    _probe_record(
        probe_id="ar_base_14",
        nl_text="Base seed: Gaddafi loyalist militia suppression in eastern Libya.",
        geography=["Libya"],
        actor_type=["government"],
        entity_hints=["Gaddafi loyalists"],
        state_flags=["escalating"],
        horizon_days=21,
        context_snippet="mercenary deployment reports",
        as_of=_V0_ORIGIN,
        assumption_emphasis=AssumptionEmphasis.SUPPRESSION,
        template_id="arab_spring_base_seed_v0",
        seed=_GLOBAL_SEED,
    ...
    _probe_record(
        probe_id="ar_base_16",
        nl_text="Base seed: Tunisian union-opposition coalition joint action timing.",
        geography=["Tunisia"],
        actor_type=["protest_group"],
        entity_hints=["UGTT", "Ennahda"],
        state_flags=["escalating"],
        horizon_days=14,
    ...
    _probe_record(
        ...
        geography=["Egypt"],
        actor_type=["protest_group"],
        entity_hints=["Muslim Brotherhood", "ElBaradei"],
        state_flags=["escalating"],
        horizon_days=21,
    ...
    _probe_record(
        probe_id="ar_base_18",
        nl_text="Base seed: Libyan rebel council tactical coordination across fronts.",
        geography=["Libya"],
        actor_type=["opposition_coalition"],
        entity_hints=["National Transitional Council", "February 17 Martyrs Brigade"],
        state_flags=["escalating"],
        horizon_days=7,
