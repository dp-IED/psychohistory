"""
Pinned calendar windows for reproducible train/holdout splits (see next_steps.md step B).
...
# Must stay inside ingest.snapshot_export._split_for_origin "development" (labeling / snapshot contract).
FRANCE_SCAFFOLD_TRAIN_ORIGIN_START: dt.date = dt.date(2021, 1, 4)
