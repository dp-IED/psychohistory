...
def test_overlay_lives_at_plugin_root() -> None:
    ...
    assert skill_meta["name"] == "due-today"
    ...
    assert "references/vault.md" in worker_body
    ...
    assert "due-today" in pointer_body
