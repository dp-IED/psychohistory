...
def main() -> None:
    ...
    prompt += [
        ...
        "  domains/*/threads/   — ongoing dynamics; extend with quarter deltas and cross-links",
        "  domains/*/concepts/  — patterns that transfer across domains; tie to Validated By / Failed By",
        "",
        "=== YOUR TASK ===",
        "",
        ...
        "   - Update domains/*/threads/ with new causal links and [[quarter]] backlinks",
        "   - Update domains/*/concepts/ with sharpened mechanisms; note which forecasts validated/failed them",
