---
name: reflector
description: After resolution day, grade the series and evolve the plugin (including exp/ branches). Spawn from Parent on a reflect tick.
---
...
Do not write `graph-vault/`. Do not open a PR for the daily live tick.
